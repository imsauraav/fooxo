...
function CheckOut() {
  ...
  return (
    <div className='min-h-screen bg-[#fff5f2] flex items-center justify-center px-4 py-10'>

      <div onClick={() => navigate("/")}
        className='fixed top-4 left-4 bg-white p-2 rounded-full shadow cursor-pointer'>
        <IoIosArrowRoundBack size={32} className='text-[#E23744]' />
      </div>

      <div className='w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-8'>
        ...
        <section>
          <h2 className='text-lg font-semibold mb-2 flex items-center gap-2'>
            <IoLocationSharp className='text-[#E23744]' /> Delivery Location
          </h2>
          ...
          <div className='flex gap-2 mb-4'>
            ...
            />
            <button className='bg-[#E23744] text-white px-3 rounded-lg' onClick={getLatLngByAddress}>
              <IoSearchOutline />
            </button>
        ...
        <section>
          ...
          <div className='grid sm:grid-cols-2 gap-4'>
            <div
              onClick={() => setPaymentMethod("cod")}
              className={`flex gap-3 p-4 rounded-xl border cursor-pointer ${paymentMethod === "cod" && "border-[#E23744] bg-red-50 shadow"}`}>
            ...
            <div
              onClick={() => setPaymentMethod("online")}
              className={`flex gap-3 p-4 rounded-xl border cursor-pointer ${paymentMethod === "online" && "border-[#E23744] bg-red-50 shadow"}`}>
        ...
        <section>
          ...
          <div className='bg-gray-50 rounded-xl p-4 space-y-2 border'>
            ...
            <div className='flex justify-between text-lg font-bold text-[#E23744]'>
              <span>Total</span>
              <span>{AmountWithDeliveryFee}</span>
            </div>
          </div>
        ...
        <button
          ...
          className='w-full bg-[#E23744] hover:bg-[#c72f3c] text-white py-3 rounded-xl font-semibold'>
