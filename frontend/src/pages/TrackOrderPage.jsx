      ...
      <div className='w-full max-w-4xl space-y-6'>
        ...
        {currentOrder?.shopOrders?.map((shopOrder, index) => (
          ...
          >
            ...
            <div>
              <p className='text-xl font-bold text-[#E23744] mb-2'>
                {shopOrder.shop.name}
              </p>
              ...
              <>
                {shopOrder.assignedDeliveryBoy ?
                  <div className='text-sm text-gray-700'>
                    ...
                    <p><span className='font-semibold'>Contact:</span> {shopOrder.assignedDeliveryBoy.mobile}</p>
                  </div>
                  :
            ...
            {/* MAP */}
            {(shopOrder.assignedDeliveryBoy && shopOrder.status !== "delivered") && (
              <div className="h-[380px] w-full rounded-2xl overflow-hidden shadow">
