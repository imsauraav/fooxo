...
function SignIn() {
    ...
    const primaryColor = "#E23744";   // Zomato red
    const hoverColor = "#c72f3c";
    const bgColor = "#fff5f2";        // soft premium background
    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4'
            ...
            <div
                className='bg-white rounded-2xl shadow-xl w-full max-w-md p-8 border'
                style={{ border: `1px solid ${borderColor}` }}
            >

                {/* FOoXO Logo Zomato Style */}
                {/* <h1
                    className='text-[36px] font-extrabold tracking-tight leading-none mb-2 select-none cursor-pointer'
                    onClick={() => navigate("/")}>
                    <span className='text-black'>F</span>
                    <span style={{ color: primaryColor }}>oo</span>
                    <span className='text-black'>x</span>
                    <span className='text-black'>o</span>
                </h1> */}
                <h1
onClick={()=>navigate("/")}
className="group text-[38px] md:text-[42px] font-extrabold italic tracking-tight cursor-pointer select-none flex items-center"
>
...
{/* OO Eyes */}
<span className="text-[#E23744] transition group-hover:text-yellow-400">
oo
</span>
...
<span className="text-black">o</span>
                ...
                <p className='text-gray-600 mb-8'>
                    Sign in to continue enjoying your favourite meals
                </p>
                ...
                <div className='mb-4'>
                    ...
                    <div className='relative'>
                        <input
                            ...
                            className='w-full rounded-lg px-3 py-2 pr-10 focus:outline-none'
                ...
                {/* SIGN IN BUTTON */}
                <button
                    className='w-full font-semibold py-2 rounded-lg transition duration-200 text-white'
                ...
                {/* GOOGLE BUTTON */}
                <button
                    className='w-full mt-4 flex items-center justify-center gap-2 border rounded-lg px-4 py-2 transition duration-200 hover:bg-gray-100'
                    style={{ border: `1px solid ${borderColor}` }}
                ...
                >
                    ...
                    <span style={{ color: primaryColor }} className='ml-1 font-medium'>
                        Sign Up
                    </span>
                </p>
