...
function AddItem() {
    ...
    return (
        <div className='flex justify-center flex-col items-center p-6 bg-gradient-to-br from-red-50 relative to-white min-h-screen'>

            <div className='absolute top-[20px] left-[20px] z-[10] mb-[10px]' onClick={() => navigate("/")}>
                <IoIosArrowRoundBack size={35} className='text-[#E23744]' />
            </div>

            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-red-100'>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    ...
                    <button
                        className='w-full bg-[#E23744] text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-[#c72f3c] hover:shadow-lg transition-all duration-200 cursor-pointer'
                        disabled={loading}
                    >
                        {loading ? <ClipLoader size={20} color='white' /> : "Save"}
                    </button>
