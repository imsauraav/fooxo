...
function UserDashboard() {
  ...
  return (
    <div className='w-screen min-h-screen flex flex-col gap-5 items-center bg-[#FFF5F2] overflow-y-auto'>
      ...
      <div className="w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]">
        ...
        <div className='w-full relative'>
          ...
          {showLeftCateButton &&
            <button
              className='absolute left-0 top-1/2 -translate-y-1/2 bg-[#E23744] text-white p-2 rounded-full shadow-lg z-10'
          ...
          {showRightCateButton &&
            <button
              className='absolute right-0 top-1/2 -translate-y-1/2 bg-[#E23744] text-white p-2 rounded-full shadow-lg z-10'
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
        ...
        <h1 className='text-gray-800 text-2xl sm:text-3xl font-semibold'>
          Best Shop in <span className="text-[#E23744]">{currentCity}</span>
        </h1>
