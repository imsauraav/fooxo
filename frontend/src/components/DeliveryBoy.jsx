...
{/* LOCATION CARD */}
<div className='bg-white rounded-2xl shadow-md p-5 w-[90%] text-center border'>
...
<h1 className='font-bold text-[#E23744] mb-3'>Today Deliveries</h1>
...
<h2 className='font-semibold'>Today's Earnings</h2>
<p className='text-2xl text-green-600 font-bold'>₹{totalEarning}</p>
</div>
</div>

{/* AVAILABLE ORDERS */}
{!currentOrder &&
<div className='bg-white rounded-xl p-5 shadow-md w-[90%]'>

<h2 className='font-bold mb-3'>Available Orders</h2>

{availableAssignments.length===0 && (
<p className='text-center text-gray-400'>No Available Orders</p>
)}

{availableAssignments.map((a,i)=>(
<div key={i} className='border p-3 rounded-lg flex justify-between mb-3'>
<div>
<p className='font-semibold'>{a.shopName}</p>
<p className='text-xs text-gray-500'>{a.deliveryAddress.text}</p>
</div>
<button className='bg-[#E23744] text-white px-4 rounded'
...
{!showOtpBox?
<button className='w-full bg-green-500 mt-4 py-2 text-white rounded'
onClick={sendOtp}>{loading?<ClipLoader size={18} color="white"/>:"Mark Delivered"}</button>
:
<div className='mt-4'>
<input className='w-full border p-2 rounded mb-3' placeholder='Enter OTP'
onChange={e=>setOtp(e.target.value)}/>
<button className='w-full bg-[#E23744] text-white py-2 rounded'
