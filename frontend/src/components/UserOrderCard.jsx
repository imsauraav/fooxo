...
<div className='bg-white rounded-2xl shadow hover:shadow-xl transition p-5 space-y-5 border'>
...
<p className='text-xs text-gray-500 uppercase'>COD</p>
:
...
<div key={index}
className='min-w-[150px] bg-white rounded-xl shadow-sm p-3 border hover:shadow-md transition'>
...
<button
className='bg-[#E23744] hover:bg-[#c92f3b] text-white px-5 py-2 rounded-full text-sm font-medium transition'
