...
<div className='group flex bg-white rounded-2xl shadow hover:shadow-xl transition-all duration-300 overflow-hidden border w-full max-w-3xl'>

{/* IMAGE */}
<div className='w-[140px] h-[120px] shrink-0 overflow-hidden'>
<img
src={data.image}
alt=""
...
<span className='font-bold text-[#E23744] text-lg'>₹{data.price}</span>

<div className='flex items-center gap-2'>

<div
className='p-2 rounded-full hover:bg-[#E23744]/10 text-[#E23744] cursor-pointer'
